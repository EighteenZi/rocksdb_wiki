## SeekForPrev API
Start from 4.13, Rocksdb added `Iterator::SeekForPrev()`. This new API will seek to the last key that less than or equal to the target key, in contrast with `Seek()`.
```cpp
