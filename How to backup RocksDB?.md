...
Be aware, that NewBackupEngine or RestoreBackupableDB take time proportional to amount of backups. So if you have slow filesystem to backup (like HDFS) and you have a lot of backups then restoring can take some time.
